                ...
                <li className='page7__ul__adapt'>
                    <ul className='page7__text__ul' id='page7__li__adapt'>
                        <li className='page7__li__textright'>
                            ...
                            Запуск пекарні в Голландії з початковим капіталом<br className='page7__br' /> 50 євро</li><br /><br /><br />
                        <li className='page7__li__textright'>
                            <img className='page7__img__disc1' src={Disc} alt="logo" />
                            Вивчення нової сфери для себе – психології. <br />Результат: підписання контракту по співпраці мінімум на рік</li><br /><br /><br />
                        <li className='page7__li__textright'>
