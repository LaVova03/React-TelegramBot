    ...
    return (
        <div className='page4__main__wrap'>
            ...
            <ul className='page4__services__grid'>
                ...
                <li>
                    Маєте унікальні знання та досвід, але не знаєте як запустити це в роботу та «завернути» в бізнес?<br /><br className='page4__br__adapt' />
                ...
                <li>
                    Готові інвестувати в стартапи різного рівня доходу та в різних країнах? <br className='page4__br__adapt' /><br className='page4__br__adapt' />
                ...
                <li>
                    ...
                    В обох з цих варіантів компанія змінюється.<br className='page4__br__adapt' /><br className='page4__br__adapt' />І іноді йдуть роки для розуміння цього.<br className='page4__br__adapt' /> Потрібні зміни, але чи згодні люди, що звикли до свої зони комфорту, на ці зміни?
                    Тут потрібно відповісти чесно лише собі.<br />
                    <span className='page4__span__desk'>Рестарт – це завжди про зміни з «готовності» до змін.</span><br /><br className='page4__br__adapt' />
                ...
                <li>
                    Враховуючи мій особистий досвід, розумію що є маса ідей як можна покращити вже існуючий бізнес. Тому, можливо, у вас є своя ідея, яку я не включила до описання.<br /><br className='page4__br__adapt' />
